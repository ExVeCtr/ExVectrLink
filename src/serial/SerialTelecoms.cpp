...
void SerialTelecomsDatalink::addHandlers() {
  ...
  telecoms.addSerialPacketHandler<SerialPacket_LinkInfo>(
      [this](const SerialPacket_LinkInfo &packet) {
        ...
        linkinfo.packetQuality = packet.local.packetQuality;
        linkinfo.packetRate = packet.local.packetRate;
        linkinfo.crsfTxFailures = packet.local.crsfTxFailures;
        ...
        linkinfo.remotePacketQuality = packet.remote.packetQuality;
        linkinfo.remotePacketRate = packet.remote.packetRate;
        linkinfo.remoteCrsfTxFailures = packet.remote.crsfTxFailures;
